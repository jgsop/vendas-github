...
import oi.github.jadersonps.rest.ApiErros;
...
public class ApplicationControllerAdvice {
    ...
    @ExceptionHandler(RegraNegociosExeption.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ApiErros handleRegraNegocioException(RegraNegociosExeption ex){
